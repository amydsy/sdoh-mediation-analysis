...
mped_9904_person$M_MEAT

mped_9904_person$M_FRANK
# 4) Individual foods (1999–2004): read & standardize ---------
iff_dir <- dir$nhanes
# Example: read just one file
path <- file.path(iff_dir, "DRXIFF.xpt")
df <- read_xpt(path)
...
#### note 
# AHEI fruit and redprocmeat slightly high compare to Wang's result
